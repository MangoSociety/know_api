...
import (
	...
	quest_repo "read-adviser-bot/internal_1/question/repos"
	quest_usecase "read-adviser-bot/internal_1/question/usecase"
...
func main() {
	...
	var token = "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"
	...
	gh_client := ghClient.NewGithubClient(token, owner, repo, sha)
