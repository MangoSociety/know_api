...
import (
	...
	"know_api/internal_1/instance/telegram/events"
...
func NewProcessor(client *telegram.Client, questionsUC questions.UseCase) *Processor {
	return &Processor{
		tg:          client,
